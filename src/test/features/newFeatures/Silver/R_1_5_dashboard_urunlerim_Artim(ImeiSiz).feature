Feature: R_1_5_dashboard_urunlerim_Artim(ImeiSiz)_kontrolu Imesiz
 ...
 #@Stok
  Scenario: R_1_5_dashboard_urunlerim_Artim(ImeiSiz) kontolü
    And I see urun page
    ...
    And I wait UrunlerimTest element 1 seconds at index 1
    And I verify Dashboard Value: UrunlerimTest at addCount 3
