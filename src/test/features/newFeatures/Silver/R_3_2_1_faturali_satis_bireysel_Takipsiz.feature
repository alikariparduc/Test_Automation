Feature: R_3_2_1_faturali_satis Takipsiz(Bireysel)
  ...
  #@Stok
  Scenario: R_3_2_1_faturali_satis Takipsiz(Bireysel)
    And I see urun page
    ...
    Then I enter "8681489388524" text to faturaliSatisArama at index 1
...
# Fatura detay inceleme
    ...
    #T#hen I click element: ozet button at index 1
    ...
    And I wait SatislerimAdeti element 1 seconds at index 1
    #And I verify Dashboard Value: UrunlerimTest at deleteCount 1 text in alert
