Feature: R_1_3_dashboard_urunlerim_sil_azalma_kontrolu
 ...
 #@Stok-silverda sil yok
  Scenario: R_1_3_dashboard_urunlerim_sil_azalma yapıldığında doğru değiştiğinin kontolü
    ...
    Then I enter "309455356084787" text to urun arama at index 1
