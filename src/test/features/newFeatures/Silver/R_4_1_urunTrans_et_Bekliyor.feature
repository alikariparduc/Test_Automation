Feature: R_4_1_urunTransfer_et_TransferdeBekliyor-Kontolu


  Background: System Login
    Given I control logout with username: "DealerMSezai"
    Given Open the url given by jenkins job
    Then I see login page
    Then I enter "DealerMSezai" text to username text area at index 1
    ...
    #@Stok
  Scenario: R_4_1_urunTransfer_et_TransferdeBekliyor kontolü
    And I see ozet page
    ...
    #Then I click element: transferOlusturBasariliClose at index 1transferEdenMagzaCode
    ...
    And I wait transferEdilenMagzaCodeR element 1 seconds at index 1
    Then I click element: transferEdilenMagzaCodeR at index 1

      And I wait transferEdilenMagzaCodeuR element 1 seconds at index 1
      Then I click element: transferEdilenMagzaCodeuR at index 1

      And I wait transferEdenMagzaCodeR element 1 seconds at index 1
      Then I click element: transferEdenMagzaCodeR at index 1

      And I wait transferEdenMagzaCodeuR element 1 seconds at index 1
      Then I click element: transferEdenMagzaCodeuR at index 1
