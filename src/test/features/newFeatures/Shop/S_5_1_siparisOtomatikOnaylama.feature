Feature: S_5_1_siparisOtomatikOnaylama


  @Stok
  Scenario Outline: S_5_1_siparisOtomatikOnaylama
    Given I control logout with username: <username>
    Given Get Token With username <username> and password <password> with "POST".
    Then Send order for storeCode <storeCode> with "POST".
    Given I control logout with username: <username>
    ...
    Examples:
      ...
      | "S324400-03"           | "Voda1234" |  "S324400-03" |
