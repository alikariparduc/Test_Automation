Feature: R_1_1_MenüleriGez
 #R kodlu shop user ile login olur, stok 2.0 daki bütün menüleri gezer her sayfada olması
 # gereken alanları kontol eder.
  ...
  @Stok
  Scenario: R_1_1_MenüleriGez
    #Ozet Ekranı
    And I see Ozet page

    #Then I wait SilverozetEkraniBasligi element 2 seconds at index 1
  ...
  Scenario: R_1_1_MenüleriGez
    ...
    Then I wait satislistesi element 5 seconds at index 1
    And I click element: satislistesi at index 1
    Then I wait faturaIade element 5 seconds at index 1
    And I click element: faturaIade at index 1

    Then I wait iadeOlustur element 2 seconds at index 1
    Then I wait iadeImeiAra element 2 seconds at index 1
    Then I wait iadeyiTamamlaButon element 2 seconds at index 1
    Then I wait iadeEkleButon element 2 seconds at index 1
    Then I wait iadeImeiAra element 2 seconds at index 1
    Then I wait iadeSku element 2 seconds at index 1
    Then I wait iadeUrunKodu element 2 seconds at index 1
    Then I wait iadeUrunAdi element 2 seconds at index 1
    Then I wait iadeImei element 2 seconds at index 1
    Then I wait iadeAdet element 2 seconds at index 1
    Then I wait iadeSatisFiyat element 2 seconds at index 1
    Then I wait iadeVergi element 2 seconds at index 1
    Then I wait iadeVergiTipi element 2 seconds at index 1
    Then I wait iadeIndirimTutari element 2 seconds at index 1
    Then I wait iadeMusteriBilgileri element 2 seconds at index 1
    Then I wait iadeToplamTutar element 2 seconds at index 1
    Then I wait iadeToplamTutarTl element 2 seconds at index 1
    Then I wait iadeNot element 2 seconds at index 1
    Then I wait iadeMusteriBilgileri element 2 seconds at index 1
