Feature: W_3_8_VDMSilverSatisiSonrasiSilverHataliFaturaliSatis


  Background: System Login
    Given I control logout with username: "DealerMAdlan"
    Given Open the url given by jenkins job
    Then I see login page
    Then I enter "DealerMAdlan" text to username text area at index 1
    Then I enter "Voda1234" text to password text area at index 1
    And  I wait login button element 30 seconds at index 1
    When I click element: login button at index 1

  @Stok
  Scenario: W_3_8_VDMSilverSatisiSonrasiSilverHataliFaturaliSatis
    And I see ozet page
    ...
    #And I control take in operations in database for IMEI: "RANDOM" barkod: "6941059630883D" SKU: "XIA0040D" and store code: "W001000-03"
    Then I need to just wait
    ...
    And I need to just wait
    Given I control logout with username: "R000470"
    Given Open the url given by jenkins job
    Then I see login page
    Then I enter "R000470" text to username text area at index 1
    Then I enter "Voda1234" text to password text area at index 1
    And  I wait login button element 30 seconds at index 1
    When I click element: login button at index 1
