Feature: W_3_2_satisYapSatisiIadeEtKontrolEt
  ...
  @Stok
  Scenario: W_3_2_satisYapSatisiIadeEtKontrolEt
    ...
    And I wait SurecBasarili element 120 seconds at index 1
    ...
    And I have to refresh the page
    And I need to just wait
    Given I control logout with username: "R000099"
    Given Open the url given by jenkins job
    Then I see login page
    Then I enter "R000099" text to username text area at index 1
    Then I enter "Voda1234" text to password text area at index 1
    And  I wait login button element 30 seconds at index 1
    When I click element: login button at index 1
    ...
    #W kodluya ürünün geri geldiğinin kontrolü
    Given I control logout with username: "DealerAKirklar5"
    Given Open the url given by jenkins job
    Then I see login page
    Then I enter "DealerAKirklar5" text to username text area at index 1
