Feature: W_4_4_urunTransferEtIptalEt
  ...
  @Stok
  Scenario: W_4_4_urunTransferEtIptalEt
    ...
    #And I wait VDMtransferEdenMagzaCodeSecenek element 3 seconds at index 1
    #Then I click element: VDMtransferEdenMagzaCodeSecenek at index 1
    #And I wait VDMtransferEdenMagzaCode element 3 seconds at index 2
    #Then I click element: VDMtransferEdenMagzaCode at index 2
    #And I wait TumuSecenek element 3 seconds at index 1
    #Then I click element: TumuSecenek at index 1
    ...
    #transferi iptal et ve transferin iptal edildiğini onayla
    And I wait transferIptalEtBtn element 3 seconds at index 1
    Then I click element: transferIptalEtBtn at index 1

    #burada database'de transfer iptal edilme süreçlerini kontrol et
    And I need to just wait
    And I control cancel transfer operations in database
    ...
    And I enter a IMEI number to transferListesiAramaAlani at index 1
    Then I click element: transferOlusturAramaBtn at index 1
    And I wait transferIptalEdildi element 3 seconds at index 1

    #transfer iptali sonrası ürünün geri geldiğini onayla
    ...
    #transferin iptal edildiğini transfer edilen mağazadan onayla
    And I see transfer page
    And I wait transfer button element 3 seconds at index 1
    Then I click element: transfer button at index 1
    And I wait transferListesi button element 3 seconds at index 1
