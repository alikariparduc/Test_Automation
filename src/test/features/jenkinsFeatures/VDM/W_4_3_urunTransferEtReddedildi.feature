Feature: W_4_3_urunTransferEtReddedildi
  ...
  @Stok
  Scenario: W_4_3_urunTransferEtReddedildi
    ...
    #transferi transfer edilen mağazadan reddet
    And I wait transferReddetBtn element 3 seconds at index 1
    Then I click element: transferReddetBtn at index 1

    #burada database'de transfer reddedilme süreçlerini kontrol et
    And I need to just wait
    And I control reject transfer operations in database
    ...
    And I wait transferReddedildi element 3 seconds at index 1
    And I need to just wait
    ...
    #transferin reddedildiğini transfer eden mağazadan kontrol et
    And I see transfer page
    And I wait transfer button element 3 seconds at index 1
    Then I click element: transfer button at index 1
    And I wait transferListesi button element 3 seconds at index 1
    ...
    #urunun geri geldigini kontrol et
