Feature: S_3_2_5_kod_faturali_satis Takipli(kurmsal Şirket)
  ...
  @Stok
  Scenario: S_3_2_5_kod_faturali_satis Takipli(kurmsal Şirket)
    And I see urun page
   ...
   # And I  get Dashboard Stock Value SatislerimAdeti
    ...
    And I wait Ekle element 2 seconds at index 1
    Then I click element: Ekle at index 1
    Then I wait urun button element 10 seconds at index 1
    And I click element: urun button at index 1
   ...
   # Then I verify the area eksiktutar by read only at index 1
    ...
    And I wait eksikAlanKntrolclose element 1 seconds at index 1
    ...
    And I wait faturaliSatisKurumsalSirket element 1 seconds at index 1
    Then I click element: faturaliSatisKurumsalSirket at index 1

    Then I scroll to the "faturaliSatisVergiD" at index 1
    Then I enter "Cucumbe VD" text to faturaliSatisVergiD at index 1

    Then I scroll to the "faturaliSatisUnvan" at index 1
    Then I enter "Selenium-Fat.Kurumsl.Şir.Takipli" text to faturaliSatisUnvan at index 1
   # Then I click element: faturaliSatisSatisTamamla at index 1
   # Then I verify the area eksikAlanKntrol by read only at index 1
   # Then I click element: eksikAlanKntrolclose at index 1

    Then I scroll to the "faturaliSatisVKN" at index 1
    Then I enter "0076308592" text to faturaliSatisVKN at index 1
    Then I click element: faturaliSatisSatisTamamla at index 1
    Then I verify the area eksikAlanKntrolclose by read only at index 1
    Then I click element: eksikAlanKntrolclose at index 1
