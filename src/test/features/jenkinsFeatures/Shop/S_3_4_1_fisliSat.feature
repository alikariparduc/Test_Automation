Feature: S_3_4_1_fisliSat

  Background: System Login
    Given I control logout with username: "DealerABalkaya10"
    Given Open the url given by jenkins job
    And I see login page
    And I enter "DealerABalkaya10" text to username text area at index 1
    And I enter "Voda1234" text to password text area at index 1
    And  I wait login button element 30 seconds at index 1
    When I click element: login button at index 1

  @Stok
  Scenario: S_3_4_1_fisliSat

    And I see urun page

      #Login sonrası DashBorad da Satislarim kontolü

    #And I wait SatislerimAdeti element 3 seconds at index 1
    ...
    And I enter a IMEI number to fisliSatisArama at index 1
    And I wait fisliSatisEkle element 3 seconds at index 1
    Then I click element: fisliSatisEkle at index 1
    ...
    And I wait fisliSatisSatisTamamla element 3 seconds at index 1
    Then I click element: fisliSatisSatisTamamla at index 1
    And I wait eksiktutar element 3 seconds at index 1
   # Then I verify the area eksiktutar by read only at index 1
    ...
    Then I enter "Fat.fişli.Takipli" text to faturaliSatisLastName at index 1
   # Then I click element: fisliSatisSatisTamamla at index 1
   # Then I verify the area eksikAlanKntrol by read only at index 1
   # Then I click element: eksikAlanKntrolclose at index 1
...
# satılan ürünün stokda olmadığını kontrol et.
    ...
    # Satış listesinden fiişli satışı iptal et
    Then I see satisListesi page

    And I wait satislistesi element 3 seconds at index 1
    ...
    And I wait belgeTipiFisli element 3 seconds at index 1
    Then I click element: belgeTipiFisli at index 1
    And I wait faturaIptalEt element 3 seconds at index 1
    ...
    And I wait satislistAramaBtn element 3 seconds at index 1
    Then I click element: satislistAramaBtn at index 1
    And I wait BasariliIptal element 3 seconds at index 1
