Feature: S_3_3_2_KampanyaliSatisBirdenFazlaImei

  Background: System Login
    Given I control logout with username: "S371200"
    Given Open the url given by jenkins job
    Then I see login page
    Then I enter "S371200" text to username text area at index 1
    Then I enter "Voda1234" text to password text area at index 1
    And  I wait login button element 30 seconds at index 1
    When I click element: login button at index 1

  @Stok
  Scenario: S_3_3_2_KampanyaliSatisBirdenFazlaImei
    And I see urun page
    ...
    Then I enter "5485104463" text to kampanyaliSatisAramaAlani at index 1
    ...
    Then I enter "359201200883286" text to satislistArama at index 1
...
# Fatura detay inceleme
 ...
 And I wait SurecBasarili element 60 seconds at index 1
    ...
    Then I enter "359201200883286" text to urun arama at index 1
