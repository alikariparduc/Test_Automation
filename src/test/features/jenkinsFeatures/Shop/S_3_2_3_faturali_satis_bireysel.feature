Feature: S_3_2_3_faturali_satis Takipli(Bireysel)


  Background: System Login
    Given I control logout with username: "DealerEAkgun7"
    Given Open the url given by jenkins job
    #Given Open the url given by jenkins job
    Then I see login page
    Then I enter "DealerEAkgun7" text to username text area at index 1
    Then I enter "Voda1234" text to password text area at index 1
    And  I wait login button element 30 seconds at index 1
    When I click element: login button at index 1

  #@Stok
  Scenario: S_3_2_3_faturali_satis Takipli(Bireysel)
    And I see urun page
   ...
   # Then I verify the area eksiktutar by read only at index 1
    ...
    And I wait SurecBasarili element 1 seconds at index 1
